...
public class ScrambleString {
	...
	private static boolean isScramble(String a, String b) {
        ...
        return solveMem(a,b, new HashMap<String, Boolean>());
	...
	private static boolean solve(String a, String b) {
		...
		for (int i = 1; i <= n - 1; i++) {
			...
			boolean case1 = solve(a.substring(0, i), b.substring(n - i))
					&& solve(a.substring(i), b.substring(0, n - i));		//swap
			boolean case2 = solve(a.substring(0, i), b.substring(0, i)) && 
					solve(a.substring(i), b.substring(i)); // no
																													// swap
